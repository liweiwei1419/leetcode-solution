...
+ （花了我非常多的时间，一定要重视起来）LeetCode 第 127 题、LeetCode 第 126 题
+ LeetCode 第 347 题：前 K 个高频元素
+ 23. 合并K个排序链表 典型问题，一定要掌握


## 二叉树相关的问题
+ 二叉树的最大深度和最小深度（第 104 和 第 111 题）
...
+ LeetCode 第 230 题：二叉搜索树中第K小的元素（我的解法比《剑指Offer》的要简单，不要被这本书带偏了）
...
+ （建议重刷，思考它和整数分解的关系，还要注意一些细节）练习1：LeetCode 第 322 题 Coin Change
+ （重刷，对这道问题的理解还不够深刻）练习2：LeetCode 第 377 题 Combination Sum IV
